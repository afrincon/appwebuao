    ...
    <div class="panel-block">
      <form class="long-form" action="{{ route('usuarios.update', $user->id) }}" method="post">
        ...
        <div class="field">
          ...
          <input type="text" name="name" class="input {{ $errors->has('name') ? ' is-danger' : '' }}" value="{{ old('name', $user->name) }}" placeholder="Ingrese el nombre del parroco">
          @if ($errors->has('name'))
        ...
        <div class="columns">
          <div class="column is-one-third">
            <div class="field">
              ...
              <input type="text" name="telefono" class="input {{ $errors->has('telefono') ? ' is-danger' : '' }}" value="{{ old('telefono', $user->telefono) }}" placeholder="Ingrese el numero teléfonico">
          ...
          <div class="column">
            <div class="field">
              ...
              <input type="date" name="fecha_nacimiento" class="input {{ $errors->has('fecha_nacimiento') ? ' is-danger' : '' }}" value="{{ old('fecha_nacimiento', $user->fecha_nacimiento) }}" placeholder="Ingrese el numero teléfonico" max="<?php echo date("Y-m-d");?>">
          ...
          <div class="column">
            <div class="field">
              ...
              <input type="date" name="fecha_ingreso" class="input {{ $errors->has('fecha_ingreso') ? ' is-danger' : '' }}" value="{{ old('fecha_ingreso', $user->fecha_ingreso) }}" placeholder="Ingrese el numero teléfonico" max="<?php echo date("Y-m-d");?>">

    ...
    <div class="panel-block">
      <form class="long-form" action="{{ route('iglesias.update', $iglesia->id) }}" method="post">
        ...
        <div class="columns">
          ...
          <div class="column">
            <div class="field">
              <select-generico :old="'{{ old('id_arquidiocesis', $iglesia->id_arquidiocesis) }}'" :propname="'id_arquidiocesis'" :url="'/iglesias/obtenerlistadodiocesis'" :label="'Diocesis principal'" :class="'select {{ $errors->has('id_arquidiocesis') ? ' is-danger' : '' }}'"></select-generico>
          ...
          <div class="column">
            <div class="field">
              <select-generico :old="'{{ old('user_id', $iglesia->user_id) }}'" :propname="'user_id'" :url="'/usuarios/obtenerlistadoparrocos'" :label="'Parroco'" :class_id="'select {{ $errors->has('user_id') ? ' is-danger' : '' }}'"></select-generico>
